        ...
        <div id="activitiesContainer" class="col-md-12 full-width-block">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                    <p>TFree of cost education does not guarantee education. DRISTI knew the importance of individual attention for a holistic learning approach. Providing this interface to the rural kids helps them learn and grow like their urban counterparts. Main targets of the tuition classes are –</p>
                    <ul>
                        <li>Admission of students in class 6th entrance exam of Jawahar Navodaya Vidyalaya.</li>
                        <li>Finding and funding the talented children in the village to complete his/her higher education in schools or colleges of repute.</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                    <p>Through DRISTI we are trying to increase computer literacy amongst the villagers. We aim to develop in them a range of skills covering -</p>
                    <ul>
                        <li>Input device, output device, operating system, hardware and software, booting, operation of basic input devices, usage of mouse and concept of ‘clicks’.</li>
                        <li>Microsoft office, paint, basic typing practice, getting accustomed to the keyboard, use of SHIFT, CTRL etc.</li>
                        <li>Conception of internet, web browsing, concepts of tabs, overview of Google usage, etc.</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                    <p>DRISTI recognizes the need of spoken and written English in today’s world and keeping that in mind has started spoken English sessions for the students from the two villages, till now we have covered -</p>
                    <ul>
                        <li>Basic lessons through video tutorial teaching them various ways to greet people.</li>
                        <li>Further videos of spoken English and homework pertaining to the sessions.</li>
                        <li>Translations of simple sentences, basic grammar lessons and spell bee.</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                    <p>The passion that girls of Jharkhand have for this game is nowhere to be seen in in other parts of India. The very own football team members of BIT Mesra are now the personal coaches for these girls.The main objectives of F.C. are -</p>
                    <ul>
                        <li>Mentoring them to work for the overall development in the game.</li>
                        <li>Providing the girls of the  village to take up the game as a career.</li>
                        <li>Providing assistance to girls who have been socially denied to choose a career for themselves in the society they are living in.</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                    <p>You can teach a student a lesson for a day; but if you can teach him to learn by creating curiosity, he will continue the learning process as long as he lives. Member of DRISTI provide all kinds of support to youngster of villages towards career -</p>
                    <ul>
                        <li>Advisory sessions for possible career alternatives and ways to achieve them.</li>
                        <li>Conducting mock practice test for examination of JEE, AIEEE, etc.</li>
